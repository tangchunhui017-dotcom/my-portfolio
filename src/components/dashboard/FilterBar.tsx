...
const CATEGORY_OPTIONS = [
    { value: '跑步', label: '运动鞋 / 跑步' },
    { value: '篮球', label: '运动鞋 / 篮球' },
    { value: '训练', label: '运动鞋 / 训练' },
    { value: '休闲', label: '休闲鞋 / 板鞋' },
    { value: '户外', label: '户外鞋 / 徒步' },
];
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <FilterSelect
                            ...
                            options={[{ value: 'all', label: '全品类' }, ...CATEGORY_OPTIONS]}
                        />
                    ...
                    <div className="flex items-center gap-1 bg-slate-100 rounded-xl p-1">
                        {COMPARE_MODE_OPTIONS.map(mode => (
                            <button
                                ...
                                className={`px-3 py-1.5 text-xs rounded-lg transition-all font-medium ${compareMode === mode

...
function HeroAndIdentity({ identity, philosophy }: { identity: BrandIdentity; philosophy: BrandPhilosophy }) {
    ...
    return (
        <section className="rounded-2xl border border-slate-100 bg-white shadow-sm px-6 lg:px-8 py-8 lg:py-10">
            <div className="text-[10px] tracking-[0.32em] text-slate-300 uppercase">BRAND POSITIONING · CHAPTER 00</div>
...
function KpiStatusBar({ kpis }: { kpis: BrandPositioningKpi[] }) {
    ...
    return (
        <section className="rounded-2xl border border-slate-100 bg-white shadow-sm px-4 py-1">
...
function BrandTierSection() {
    ...
    return (
        <section className="rounded-2xl border border-stone-200 bg-stone-50/80 shadow-sm px-6 lg:px-8 py-8 lg:py-10">
            ...
            <div className="mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {segments.map((seg) => {
                        ...
                        return (
                            <div key={seg.segmentName} className="space-y-4">
                                <div className="flex items-baseline gap-3">
        ...
        <section className="rounded-2xl border border-amber-100 bg-amber-50/40 shadow-sm px-6 lg:px-8 py-8 lg:py-10">
            ...
            <details open className="mt-8 group">
                ...
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
                    {items.map((it) => (
                        <div key={it.scenario} className="rounded-xl border border-slate-100 bg-white p-4 space-y-2">
                            <div className="flex items-center justify-between">
...
function StrategyMatrixSection({ items }: { items: BrandStrategyMatrixItem[] }) {
    return (
        <section>
            ...
            <div className="rounded-xl border border-slate-100 bg-white shadow-sm overflow-hidden mt-3">
                <table className="w-full text-xs">
                    ...
                    <tbody className="divide-y divide-slate-50">
                        {items.map((it) => {
                            ...
                            return (
                                <tr key={it.strategyId} className="hover:bg-slate-50/60">
...
function PositioningHealthCheckSection({
    ...
    return (
        <section>
            ...
            />
            <div className="rounded-xl border border-slate-100 bg-white shadow-sm overflow-hidden mt-3 divide-y divide-slate-50">
                {items.map((it) => {
                    const style = STATUS_STYLE[it.riskLevel];
                    return (
                        <div key={it.checkId} className="px-4 py-3 flex items-start gap-3 hover:bg-slate-50/60">
                            ...
                            <div className="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-[180px_1fr_1fr_140px] gap-3 items-start">
                                ...
                                <div className="text-right">
                                    <button
                                        ...
                                        className="text-[11px] px-2 py-1 rounded-md border border-slate-200 bg-white text-slate-600 hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700 disabled:opacity-50"
                                    >
                                        {it.jumpAction} ↗
                                    </button>
                                </div>
    ...
    return (
        <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mt-3">
                {items.map((out) => (
                    <div key={out.outputId} className="rounded-xl border border-slate-100 bg-white shadow-sm p-4 space-y-2">
                        <div className="flex items-center gap-2">
                ...
                {items.map((it) => {
                    ...
                    return (
                        <button
                            ...
                            className="rounded-xl border border-slate-100 bg-white shadow-sm p-4 text-left space-y-2 hover:border-sky-300 hover:bg-sky-50/40 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            <div className="flex items-center gap-2">
                            ...
                            <div className="text-[11px] text-sky-700 font-medium pt-2 border-t border-slate-50">
                                {it.actionLabel} ↗
                            </div>
                        </button>
                    );

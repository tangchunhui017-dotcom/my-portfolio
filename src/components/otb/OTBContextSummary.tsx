            ...
            <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                <div className="min-w-0">
                    <div className="flex items-center gap-2">
                        <span className="rounded-full bg-slate-900 px-2.5 py-1 text-[11px] font-semibold text-white">当前口径</span>
                        <span className="text-[11px] text-slate-400">继承商品企划全局筛选，OTB 内部不重复筛选</span>
                    </div>
